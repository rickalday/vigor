...
if ( class_exists( 'WP_Customize_Control' ) ) {
     ...
     */
    class Vigor_Multi_Image_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_media();
            wp_enqueue_script( 'multi-image-control', get_template_directory_uri() . '/inc/assets/js/customizer-multi-image.js', array('jquery', 'jquery-ui-sortable'), '', true );
        }
